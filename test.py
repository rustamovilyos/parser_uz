...
def check_to_img(file_path):
    ...
    try:
        if reader.pages[0].images:
            DocumentParser(pdf2img2txt(file_path))
...
def write_to_csv(list_text: list):
    ...
    check_file_exist = os.path.exists("e-book.csv")
    file_for_write = "e-book.csv"
    poem_title = "Одил Ёқубов Улуғбек ҳазинаси"
    # print(list_text)
